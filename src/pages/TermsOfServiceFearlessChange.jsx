const TermsOfServiceFearlessChange = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">
            Terms of Service for Fearless Change
          </h1>
          ...
          <div className="text-gray-600 dark:text-gray-300 space-y-6">
            ...
            <section>
              ...
              <p>
                By downloading, installing, or using the Fearless Change mobile application ("the App"), 
            ...
            <section>
              ...
              <p>
                Fearless Change is a mobile application developed by Scrimmage, LLC that provides personal development 
                resources and guidance. The App is designed to help users build confidence and manage change in 
            ...
            <section>
              ...
              <p>
                You may be able to create, upload, or share content through the App. You retain ownership of your content, 
                but grant us a license to use it as necessary to provide the App's functionality.
              </p>
            </section>
...
export default TermsOfServiceFearlessChange;