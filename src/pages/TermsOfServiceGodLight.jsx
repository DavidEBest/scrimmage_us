const TermsOfServiceGodLight = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">
            Terms of Service for GodLight Movement
          </h1>
          ...
          <div className="text-gray-600 dark:text-gray-300 space-y-6">
            ...
            <section>
              ...
              <p>
                By downloading, installing, or using the GodLight Movement mobile application ("the App"), 
            ...
            <section>
              ...
              <p>
                GodLight Movement is a mobile application developed by Scrimmage, LLC that provides spiritual 
                guidance and community resources. The App is designed to help users connect with faith-based 
...
export default TermsOfServiceGodLight;